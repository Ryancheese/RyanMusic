...
export const parseTTML = (
 ...
 // RyanMusic does not ship the Folia TTML parser dependency.
 // Fall back to LRC so unknown TTML payloads still render something.
 return parseLRC(ttmlString, translationString, options, romanizationString);
};
...
export const parseKRC = (
 ...
 const decoded = new TextDecoder('utf-8').decode(Uint8Array.from(atob(cleanB64), c => c.charCodeAt(0)));
